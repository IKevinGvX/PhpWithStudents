...
if ($con) {
    $comm = $con->prepare("CALL ListarLibros();");
    $comm->execute();
...
<body>
    <div class="container">
        ...
        <div class="mb-3">
            <a href="nuevobooks.php" class="btn btn-primary">New Books</a>
            ...
            <tbody>
                <?php foreach ($result as $row) { ?>
                    <tr>
                        ...
                        <td>
                            <a href="editbooks.php?id=<?php echo $row['id_libro']; ?>"
                                class="btn btn-warning btn-sm">Editar</a>
                            <a href="eliminarbooks.php?id=<?php echo $row['id_libro']; ?>"
